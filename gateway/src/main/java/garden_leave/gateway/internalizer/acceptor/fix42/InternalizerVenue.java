...
public class InternalizerVenue extends GatewayAcceptor {
  private static final Logger logger = LoggerFactory.getLogger(InternalizerVenue.class);

  private final Disruptor<MessageEvent> disruptor;
  private final RingBuffer<MessageEvent> ringBuffer;
  private final MessageConsumer messageConsumer;

  public InternalizerVenue() {
  ...
  public void createFixAcceptor(final SessionSettings sessionSettings) throws ConfigError {
    this.messageConsumer.createInternalizerClient(
        sessionSettings.getString("InternalizerTargetAddress"));
    this.acceptor =
