...
public final class Header extends quickfix.Message.Header {
  ...
  private final FieldFactory.TimeStampField onBehalfOfSendingTimeField =
      FieldFactory.newTimeStampField(370);
  public boolean hasOnBehalfOfSendingTime() throws quickfix.FieldNotFound {
    return isSetField(370);
  }
  public long getOnBehalfOfSendingTime() throws quickfix.FieldNotFound {
    return FieldValue.of(getField(onBehalfOfSendingTimeField));
  }
  public Header setOnBehalfOfSendingTime(final long value) {
    setField(FieldValue.to(onBehalfOfSendingTimeField, value));
    return this;
  }
  public Header setOnBehalfOfSendingTime(final quickfix.field.OnBehalfOfSendingTime value) {
    setField(FieldValue.to(onBehalfOfSendingTimeField, FieldValue.of(value)));
    return this;
  }
  ...
  public Header(final quickfix.Message msg, final String beginString, final String msgType) {
    super(new int[] {8, 9, 35, 49, 56, 115, 128, 90, 91, 34, 50, 142, 57, 143, 116, 144, 129, 145,
        43, 97, 52, 122, 212, 213, 347, 369, 370, 0});
    setMsgType(msgType);
    setBeginString(beginString);
  }

  public void fromProto(final garden_leave.fix42.proto.FIX42Protos.Header proto) {
    final garden_leave.fix42.proto.FIX42Protos.Header.FieldPresence fieldPresence =
    ...
    if (fieldPresence.getOnBehalfOfSendingTime()) {
      this.setOnBehalfOfSendingTime(proto.getOnBehalfOfSendingTime());
    }
  }

  public garden_leave.fix42.proto.FIX42Protos.Header.Builder toBuilder()
      throws quickfix.FieldNotFound {
    final garden_leave.fix42.proto.FIX42Protos.Header.Builder builder =
        garden_leave.fix42.proto.FIX42Protos.Header.newBuilder();
    final garden_leave.fix42.proto.FIX42Protos.Header.FieldPresence.Builder presenceBuilder =
    ...
    if (this.hasOnBehalfOfSendingTime()) {
      builder.setOnBehalfOfSendingTime(this.getOnBehalfOfSendingTime());
      presenceBuilder.setOnBehalfOfSendingTime(true);
    }
