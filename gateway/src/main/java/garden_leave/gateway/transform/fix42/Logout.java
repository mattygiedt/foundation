...
public final class Logout extends quickfix.Message {
  ...
  public static Function<garden_leave.gateway.transform.fix42.Logout,
      garden_leave.fix42.proto.FIX42Protos.Logout> fixToProto = (fix) -> {
    if (fix == null) {
      return garden_leave.fix42.proto.FIX42Protos.Logout.getDefaultInstance();
    }

    final garden_leave.fix42.proto.FIX42Protos.Logout.Builder builder =
        garden_leave.fix42.proto.FIX42Protos.Logout.newBuilder();
    final garden_leave.fix42.proto.FIX42Protos.Logout.FieldPresence.Builder presenceBuilder =
        garden_leave.fix42.proto.FIX42Protos.Logout.FieldPresence.newBuilder();
  ...
  public static Function<garden_leave.fix42.proto.FIX42Protos.Logout,
      garden_leave.gateway.transform.fix42.Logout> protoToFix = (proto) -> {
    final io.opentelemetry.api.trace.Span span = garden_leave.utils.Telemetry.startSpan(
        tracer, "garden_leave.gateway.transform.fix42.Logout.protoToFix");
    try (io.opentelemetry.context.Scope ignored = span.makeCurrent()) {
      final garden_leave.gateway.transform.fix42.Logout fix =
      ...
      final garden_leave.fix42.proto.FIX42Protos.Logout.FieldPresence fieldPresence =
