...
public final class Heartbeat extends quickfix.Message {
  ...
  public static Function<garden_leave.gateway.transform.fix44.Heartbeat,
      garden_leave.fix44.proto.FIX44Protos.Heartbeat> fixToProto = (fix) -> {
    if (fix == null) {
      return garden_leave.fix44.proto.FIX44Protos.Heartbeat.getDefaultInstance();
    }

    final garden_leave.fix44.proto.FIX44Protos.Heartbeat.Builder builder =
        garden_leave.fix44.proto.FIX44Protos.Heartbeat.newBuilder();
    final garden_leave.fix44.proto.FIX44Protos.Heartbeat.FieldPresence.Builder presenceBuilder =
        garden_leave.fix44.proto.FIX44Protos.Heartbeat.FieldPresence.newBuilder();
  ...
  public static Function<garden_leave.fix44.proto.FIX44Protos.Heartbeat,
      garden_leave.gateway.transform.fix44.Heartbeat> protoToFix = (proto) -> {
    final io.opentelemetry.api.trace.Span span = garden_leave.utils.Telemetry.startSpan(
        tracer, "garden_leave.gateway.transform.fix44.Heartbeat.protoToFix");
    try (io.opentelemetry.context.Scope ignored = span.makeCurrent()) {
      final garden_leave.gateway.transform.fix44.Heartbeat fix =
      ...
      final garden_leave.fix44.proto.FIX44Protos.Heartbeat.FieldPresence fieldPresence =
