...
public final class Reject extends quickfix.Message {
  ...
  public static Function<garden_leave.gateway.transform.fix44.Reject,
      garden_leave.fix44.proto.FIX44Protos.Reject> fixToProto = (fix) -> {
    if (fix == null) {
      return garden_leave.fix44.proto.FIX44Protos.Reject.getDefaultInstance();
    }

    final garden_leave.fix44.proto.FIX44Protos.Reject.Builder builder =
        garden_leave.fix44.proto.FIX44Protos.Reject.newBuilder();
    final garden_leave.fix44.proto.FIX44Protos.Reject.FieldPresence.Builder presenceBuilder =
        garden_leave.fix44.proto.FIX44Protos.Reject.FieldPresence.newBuilder();
  ...
  public static Function<garden_leave.fix44.proto.FIX44Protos.Reject,
      garden_leave.gateway.transform.fix44.Reject> protoToFix = (proto) -> {
    final io.opentelemetry.api.trace.Span span = garden_leave.utils.Telemetry.startSpan(
        tracer, "garden_leave.gateway.transform.fix44.Reject.protoToFix");
    try (io.opentelemetry.context.Scope ignored = span.makeCurrent()) {
      final garden_leave.gateway.transform.fix44.Reject fix =
      ...
      final garden_leave.fix44.proto.FIX44Protos.Reject.FieldPresence fieldPresence =
