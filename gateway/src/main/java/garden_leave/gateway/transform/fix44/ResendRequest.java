...
public final class ResendRequest extends quickfix.Message {
  ...
  public static Function<garden_leave.gateway.transform.fix44.ResendRequest,
      garden_leave.fix44.proto.FIX44Protos.ResendRequest> fixToProto = (fix) -> {
    if (fix == null) {
      return garden_leave.fix44.proto.FIX44Protos.ResendRequest.getDefaultInstance();
    }

    final garden_leave.fix44.proto.FIX44Protos.ResendRequest.Builder builder =
        garden_leave.fix44.proto.FIX44Protos.ResendRequest.newBuilder();
    final garden_leave.fix44.proto.FIX44Protos.ResendRequest.FieldPresence.Builder presenceBuilder =
        garden_leave.fix44.proto.FIX44Protos.ResendRequest.FieldPresence.newBuilder();
  ...
  public static Function<garden_leave.fix44.proto.FIX44Protos.ResendRequest,
      garden_leave.gateway.transform.fix44.ResendRequest> protoToFix = (proto) -> {
    final io.opentelemetry.api.trace.Span span = garden_leave.utils.Telemetry.startSpan(
        tracer, "garden_leave.gateway.transform.fix44.ResendRequest.protoToFix");
    try (io.opentelemetry.context.Scope ignored = span.makeCurrent()) {
      final garden_leave.gateway.transform.fix44.ResendRequest fix =
      ...
      final garden_leave.fix44.proto.FIX44Protos.ResendRequest.FieldPresence fieldPresence =
