...
public final class SequenceReset extends quickfix.Message {
  ...
  public static Function<garden_leave.gateway.transform.fix44.SequenceReset,
      garden_leave.fix44.proto.FIX44Protos.SequenceReset> fixToProto = (fix) -> {
    if (fix == null) {
      return garden_leave.fix44.proto.FIX44Protos.SequenceReset.getDefaultInstance();
    }

    final garden_leave.fix44.proto.FIX44Protos.SequenceReset.Builder builder =
        garden_leave.fix44.proto.FIX44Protos.SequenceReset.newBuilder();
    final garden_leave.fix44.proto.FIX44Protos.SequenceReset.FieldPresence.Builder presenceBuilder =
        garden_leave.fix44.proto.FIX44Protos.SequenceReset.FieldPresence.newBuilder();
  ...
  public static Function<garden_leave.fix44.proto.FIX44Protos.SequenceReset,
      garden_leave.gateway.transform.fix44.SequenceReset> protoToFix = (proto) -> {
    final io.opentelemetry.api.trace.Span span = garden_leave.utils.Telemetry.startSpan(
        tracer, "garden_leave.gateway.transform.fix44.SequenceReset.protoToFix");
    try (io.opentelemetry.context.Scope ignored = span.makeCurrent()) {
      final garden_leave.gateway.transform.fix44.SequenceReset fix =
      ...
      final garden_leave.fix44.proto.FIX44Protos.SequenceReset.FieldPresence fieldPresence =
