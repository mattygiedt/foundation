...
public final class OrderCancelReject extends quickfix.Message {
  ...
  public static Function<garden_leave.gateway.transform.fix44.OrderCancelReject,
      garden_leave.fix44.proto.FIX44Protos.OrderCancelReject> fixToProto = (fix) -> {
    if (fix == null) {
      return garden_leave.fix44.proto.FIX44Protos.OrderCancelReject.getDefaultInstance();
    }

    final garden_leave.fix44.proto.FIX44Protos.OrderCancelReject.Builder builder =
        garden_leave.fix44.proto.FIX44Protos.OrderCancelReject.newBuilder();
    final garden_leave.fix44.proto.FIX44Protos.OrderCancelReject.FieldPresence
        .Builder presenceBuilder =
        garden_leave.fix44.proto.FIX44Protos.OrderCancelReject.FieldPresence.newBuilder();
  ...
  public static Function<garden_leave.fix44.proto.FIX44Protos.OrderCancelReject,
      garden_leave.gateway.transform.fix44.OrderCancelReject> protoToFix = (proto) -> {
    final io.opentelemetry.api.trace.Span span = garden_leave.utils.Telemetry.startSpan(
        tracer, "garden_leave.gateway.transform.fix44.OrderCancelReject.protoToFix");
    try (io.opentelemetry.context.Scope ignored = span.makeCurrent()) {
      final garden_leave.gateway.transform.fix44.OrderCancelReject fix =
      ...
      final garden_leave.fix44.proto.FIX44Protos.OrderCancelReject.FieldPresence fieldPresence =
