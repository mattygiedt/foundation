...
public final class QuoteCancel extends quickfix.Message {
  ...
  public static class NoPartyIds extends quickfix.Group {
    public static class NoPartySubIds extends quickfix.Group {
      ...
      public void fromProto(final garden_leave.fix50sp2.proto.FIX50SP2Protos.QuoteCancel.NoPartyIds
                                .NoPartySubIds proto) {
        final garden_leave.fix50sp2.proto.FIX50SP2Protos.QuoteCancel.NoPartyIds.NoPartySubIds
      ...
      public garden_leave.fix50sp2.proto.FIX50SP2Protos.QuoteCancel.NoPartyIds.NoPartySubIds.Builder
      toBuilder() throws quickfix.FieldNotFound {
        final garden_leave.fix50sp2.proto.FIX50SP2Protos.QuoteCancel.NoPartyIds.NoPartySubIds
            .Builder builder = garden_leave.fix50sp2.proto.FIX50SP2Protos.QuoteCancel.NoPartyIds
                                   .NoPartySubIds.newBuilder();
        final garden_leave.fix50sp2.proto.FIX50SP2Protos.QuoteCancel.NoPartyIds.NoPartySubIds
            .FieldPresence.Builder presenceBuilder =
            garden_leave.fix50sp2.proto.FIX50SP2Protos.QuoteCancel.NoPartyIds.NoPartySubIds
    ...
    public void fromProto(
        final garden_leave.fix50sp2.proto.FIX50SP2Protos.QuoteCancel.NoPartyIds proto) {
      final garden_leave.fix50sp2.proto.FIX50SP2Protos.QuoteCancel.NoPartyIds
          .FieldPresence fieldPresence = proto.getFieldPresence();
    ...
    public garden_leave.fix50sp2.proto.FIX50SP2Protos.QuoteCancel.NoPartyIds.Builder toBuilder()
        throws quickfix.FieldNotFound {
      final garden_leave.fix50sp2.proto.FIX50SP2Protos.QuoteCancel.NoPartyIds.Builder builder =
          garden_leave.fix50sp2.proto.FIX50SP2Protos.QuoteCancel.NoPartyIds.newBuilder();
      final garden_leave.fix50sp2.proto.FIX50SP2Protos.QuoteCancel.NoPartyIds.FieldPresence
          .Builder presenceBuilder = garden_leave.fix50sp2.proto.FIX50SP2Protos.QuoteCancel
  ...
  public static class NoTargetPartyIds extends quickfix.Group {
    private final quickfix.StringField targetPartyIdField = FieldFactory.newStringField(1462);
    public boolean hasTargetPartyId() throws quickfix.FieldNotFound {
      return isSetField(1462);
    }
    public String getTargetPartyId() throws quickfix.FieldNotFound {
      return FieldValue.of(getField(targetPartyIdField));
    }
    public NoTargetPartyIds setTargetPartyId(final String value) {
      setField(FieldValue.to(targetPartyIdField, value));
      return this;
    }
    public NoTargetPartyIds setTargetPartyId(final quickfix.field.TargetPartyID value) {
      setField(FieldValue.to(targetPartyIdField, FieldValue.of(value)));
      return this;
    }

    private final quickfix.CharField targetPartyIdSourceField = FieldFactory.newCharField(1463);
    public boolean hasTargetPartyIdSource() throws quickfix.FieldNotFound {
      return isSetField(1463);
    }
    public int getTargetPartyIdSource() throws quickfix.FieldNotFound {
      return FieldValue.of(getField(targetPartyIdSourceField));
    }
    public NoTargetPartyIds setTargetPartyIdSource(final int value) {
      setField(FieldValue.to(targetPartyIdSourceField, value));
      return this;
    }
    public NoTargetPartyIds setTargetPartyIdSource(final char value) {
      setField(FieldValue.to(targetPartyIdSourceField, value));
      return this;
    }
    public NoTargetPartyIds setTargetPartyIdSource(final String value) {
      setField(FieldValue.to(targetPartyIdSourceField, value));
      return this;
    }
    public NoTargetPartyIds setTargetPartyIdSource(final quickfix.field.TargetPartyIDSource value) {
      setField(FieldValue.to(targetPartyIdSourceField, FieldValue.of(value)));
      return this;
    }

    private final quickfix.IntField targetPartyRoleField = FieldFactory.newIntField(1464);
    public boolean hasTargetPartyRole() throws quickfix.FieldNotFound {
      return isSetField(1464);
    }
    public int getTargetPartyRole() throws quickfix.FieldNotFound {
      return FieldValue.of(getField(targetPartyRoleField));
    }
    public NoTargetPartyIds setTargetPartyRole(final int value) {
      setField(FieldValue.to(targetPartyRoleField, value));
      return this;
    }
    public NoTargetPartyIds setTargetPartyRole(final quickfix.field.TargetPartyRole value) {
      setField(FieldValue.to(targetPartyRoleField, FieldValue.of(value)));
      return this;
    }

    public NoTargetPartyIds() {
      super(1461, 1462, new int[] {1462, 1463, 1464, 0});
    }
    ...
    public void fromProto(
        final garden_leave.fix50sp2.proto.FIX50SP2Protos.QuoteCancel.NoTargetPartyIds proto) {
      final garden_leave.fix50sp2.proto.FIX50SP2Protos.QuoteCancel.NoTargetPartyIds
          .FieldPresence fieldPresence = proto.getFieldPresence();

      if (fieldPresence.getTargetPartyId()) {
        this.setTargetPartyId(proto.getTargetPartyId());
      }
      if (fieldPresence.getTargetPartyIdSource()) {
        this.setTargetPartyIdSource(proto.getTargetPartyIdSource());
      }
      if (fieldPresence.getTargetPartyRole()) {
        this.setTargetPartyRole(proto.getTargetPartyRole());
      }
    }

    public garden_leave.fix50sp2.proto.FIX50SP2Protos.QuoteCancel.NoTargetPartyIds.Builder
    toBuilder() throws quickfix.FieldNotFound {
      final garden_leave.fix50sp2.proto.FIX50SP2Protos.QuoteCancel.NoTargetPartyIds
          .Builder builder =
          garden_leave.fix50sp2.proto.FIX50SP2Protos.QuoteCancel.NoTargetPartyIds.newBuilder();
      final garden_leave.fix50sp2.proto.FIX50SP2Protos.QuoteCancel.NoTargetPartyIds.FieldPresence
          .Builder presenceBuilder = garden_leave.fix50sp2.proto.FIX50SP2Protos.QuoteCancel
                                         .NoTargetPartyIds.FieldPresence.newBuilder();

      if (this.hasTargetPartyId()) {
        builder.setTargetPartyId(this.getTargetPartyId());
        presenceBuilder.setTargetPartyId(true);
      }
      if (this.hasTargetPartyIdSource()) {
        builder.setTargetPartyIdSource(this.getTargetPartyIdSource());
        presenceBuilder.setTargetPartyIdSource(true);
      }
      if (this.hasTargetPartyRole()) {
        builder.setTargetPartyRole(this.getTargetPartyRole());
        presenceBuilder.setTargetPartyRole(true);
      }
      builder.setFieldPresence(presenceBuilder.build());
      return builder;
    }
  ...
  public static class NoQuoteEntries extends quickfix.Group {
    public static class NoSecurityAltId extends quickfix.Group {
      ...
      public void fromProto(final garden_leave.fix50sp2.proto.FIX50SP2Protos.QuoteCancel
                                .NoQuoteEntries.NoSecurityAltId proto) {
        final garden_leave.fix50sp2.proto.FIX50SP2Protos.QuoteCancel.NoQuoteEntries.NoSecurityAltId
            .FieldPresence fieldPresence = proto.getFieldPresence();
      ...
      public garden_leave.fix50sp2.proto.FIX50SP2Protos.QuoteCancel.NoQuoteEntries.NoSecurityAltId
          .Builder
          toBuilder() throws quickfix.FieldNotFound {
        final garden_leave.fix50sp2.proto.FIX50SP2Protos.QuoteCancel.NoQuoteEntries.NoSecurityAltId
            .Builder builder = garden_leave.fix50sp2.proto.FIX50SP2Protos.QuoteCancel.NoQuoteEntries
                                   .NoSecurityAltId.newBuilder();
        final garden_leave.fix50sp2.proto.FIX50SP2Protos.QuoteCancel.NoQuoteEntries.NoSecurityAltId
            .FieldPresence.Builder presenceBuilder =
            garden_leave.fix50sp2.proto.FIX50SP2Protos.QuoteCancel.NoQuoteEntries.NoSecurityAltId
                .FieldPresence.newBuilder();
    ...
    public static class NoEvents extends quickfix.Group {
      ...
      public void fromProto(final garden_leave.fix50sp2.proto.FIX50SP2Protos.QuoteCancel
                                .NoQuoteEntries.NoEvents proto) {
        final garden_leave.fix50sp2.proto.FIX50SP2Protos.QuoteCancel.NoQuoteEntries.NoEvents
            .FieldPresence fieldPresence = proto.getFieldPresence();
      ...
      public garden_leave.fix50sp2.proto.FIX50SP2Protos.QuoteCancel.NoQuoteEntries.NoEvents.Builder
      toBuilder() throws quickfix.FieldNotFound {
        final garden_leave.fix50sp2.proto.FIX50SP2Protos.QuoteCancel.NoQuoteEntries.NoEvents
            .Builder builder = garden_leave.fix50sp2.proto.FIX50SP2Protos.QuoteCancel.NoQuoteEntries
                                   .NoEvents.newBuilder();
        final garden_leave.fix50sp2.proto.FIX50SP2Protos.QuoteCancel.NoQuoteEntries.NoEvents
            .FieldPresence.Builder presenceBuilder =
            garden_leave.fix50sp2.proto.FIX50SP2Protos.QuoteCancel.NoQuoteEntries.NoEvents
                .FieldPresence.newBuilder();
    ...
    public static class NoInstrumentParties extends quickfix.Group {
      public static class NoInstrumentPartySubIds extends quickfix.Group {
        ...
        public void fromProto(
            final garden_leave.fix50sp2.proto.FIX50SP2Protos.QuoteCancel.NoQuoteEntries
        ...
        public garden_leave.fix50sp2.proto.FIX50SP2Protos.QuoteCancel.NoQuoteEntries
            .NoInstrumentParties.NoInstrumentPartySubIds.Builder
            toBuilder() throws quickfix.FieldNotFound {
          final garden_leave.fix50sp2.proto.FIX50SP2Protos.QuoteCancel.NoQuoteEntries
              .NoInstrumentParties.NoInstrumentPartySubIds.Builder builder =
              garden_leave.fix50sp2.proto.FIX50SP2Protos.QuoteCancel.NoQuoteEntries
      ...
      public void fromProto(final garden_leave.fix50sp2.proto.FIX50SP2Protos.QuoteCancel
                                .NoQuoteEntries.NoInstrumentParties proto) {
        final garden_leave.fix50sp2.proto.FIX50SP2Protos.QuoteCancel.NoQuoteEntries
    ...
    public static class NoComplexEvents extends quickfix.Group {
      public static class NoComplexEventDates extends quickfix.Group {
        public static class NoComplexEventTimes extends quickfix.Group {
          ...
          public garden_leave.fix50sp2.proto.FIX50SP2Protos.QuoteCancel.NoQuoteEntries
            ...
            final garden_leave.fix50sp2.proto.FIX50SP2Protos.QuoteCancel.NoQuoteEntries
                ...
                .Builder presenceBuilder = garden_leave.fix50sp2.proto.FIX50SP2Protos.QuoteCancel
                                               .NoQuoteEntries.NoComplexEvents.NoComplexEventDates
        ...
        public void fromProto(final garden_leave.fix50sp2.proto.FIX50SP2Protos.QuoteCancel
                                  .NoQuoteEntries.NoComplexEvents.NoComplexEventDates proto) {
          final garden_leave.fix50sp2.proto.FIX50SP2Protos.QuoteCancel.NoQuoteEntries
        ...
        public garden_leave.fix50sp2.proto.FIX50SP2Protos.QuoteCancel.NoQuoteEntries.NoComplexEvents
            .NoComplexEventDates.Builder
            toBuilder() throws quickfix.FieldNotFound {
          final garden_leave.fix50sp2.proto.FIX50SP2Protos.QuoteCancel.NoQuoteEntries
              .NoComplexEvents.NoComplexEventDates.Builder builder =
              garden_leave.fix50sp2.proto.FIX50SP2Protos.QuoteCancel.NoQuoteEntries.NoComplexEvents
      ...
      public void fromProto(final garden_leave.fix50sp2.proto.FIX50SP2Protos.QuoteCancel
                                .NoQuoteEntries.NoComplexEvents proto) {
        final garden_leave.fix50sp2.proto.FIX50SP2Protos.QuoteCancel.NoQuoteEntries.NoComplexEvents
            .FieldPresence fieldPresence = proto.getFieldPresence();
    ...
    public static class NoUnderlyings extends quickfix.Group {
      public static class NoUnderlyingSecurityAltId extends quickfix.Group {
        ...
        public void fromProto(final garden_leave.fix50sp2.proto.FIX50SP2Protos.QuoteCancel
                                  .NoQuoteEntries.NoUnderlyings.NoUnderlyingSecurityAltId proto) {
          final garden_leave.fix50sp2.proto.FIX50SP2Protos.QuoteCancel.NoQuoteEntries.NoUnderlyings
        ...
        public garden_leave.fix50sp2.proto.FIX50SP2Protos.QuoteCancel.NoQuoteEntries.NoUnderlyings
            .NoUnderlyingSecurityAltId.Builder
            toBuilder() throws quickfix.FieldNotFound {
          final garden_leave.fix50sp2.proto.FIX50SP2Protos.QuoteCancel.NoQuoteEntries.NoUnderlyings
              .NoUnderlyingSecurityAltId.Builder builder =
              garden_leave.fix50sp2.proto.FIX50SP2Protos.QuoteCancel.NoQuoteEntries.NoUnderlyings
      ...
      public static class NoUnderlyingStips extends quickfix.Group {
        ...
        public void fromProto(final garden_leave.fix50sp2.proto.FIX50SP2Protos.QuoteCancel
                                  .NoQuoteEntries.NoUnderlyings.NoUnderlyingStips proto) {
          final garden_leave.fix50sp2.proto.FIX50SP2Protos.QuoteCancel.NoQuoteEntries.NoUnderlyings
      ...
      public static class NoUndlyInstrumentParties extends quickfix.Group {
        ...
        public void fromProto(final garden_leave.fix50sp2.proto.FIX50SP2Protos.QuoteCancel
                                  .NoQuoteEntries.NoUnderlyings.NoUndlyInstrumentParties proto) {
          final garden_leave.fix50sp2.proto.FIX50SP2Protos.QuoteCancel.NoQuoteEntries.NoUnderlyings
      ...
      public void fromProto(final garden_leave.fix50sp2.proto.FIX50SP2Protos.QuoteCancel
                                .NoQuoteEntries.NoUnderlyings proto) {
        final garden_leave.fix50sp2.proto.FIX50SP2Protos.QuoteCancel.NoQuoteEntries.NoUnderlyings
            .FieldPresence fieldPresence = proto.getFieldPresence();
    ...
    public static class NoLegs extends quickfix.Group {
      public static class NoLegSecurityAltId extends quickfix.Group {
        ...
        public void fromProto(final garden_leave.fix50sp2.proto.FIX50SP2Protos.QuoteCancel
                                  .NoQuoteEntries.NoLegs.NoLegSecurityAltId proto) {
          final garden_leave.fix50sp2.proto.FIX50SP2Protos.QuoteCancel.NoQuoteEntries.NoLegs
        ...
        public garden_leave.fix50sp2.proto.FIX50SP2Protos.QuoteCancel.NoQuoteEntries.NoLegs
            .NoLegSecurityAltId.Builder
            toBuilder() throws quickfix.FieldNotFound {
          final garden_leave.fix50sp2.proto.FIX50SP2Protos.QuoteCancel.NoQuoteEntries.NoLegs
              .NoLegSecurityAltId.Builder builder =
              garden_leave.fix50sp2.proto.FIX50SP2Protos.QuoteCancel.NoQuoteEntries.NoLegs
      ...
      public garden_leave.fix50sp2.proto.FIX50SP2Protos.QuoteCancel.NoQuoteEntries.NoLegs.Builder
      toBuilder() throws quickfix.FieldNotFound {
        final garden_leave.fix50sp2.proto.FIX50SP2Protos.QuoteCancel.NoQuoteEntries.NoLegs
            .Builder builder = garden_leave.fix50sp2.proto.FIX50SP2Protos.QuoteCancel.NoQuoteEntries
                                   .NoLegs.newBuilder();
    ...
    public NoQuoteEntries setSecurityIdSource(final String value) {
      setField(FieldValue.to(securityIdSourceField, value));
      return this;
    }
    public NoQuoteEntries setSecurityIdSource(final quickfix.field.SecurityIDSource value) {
    ...
    public NoQuoteEntries setProduct(final int value) {
      setField(FieldValue.to(productField, value));
      return this;
    }
    public NoQuoteEntries setProduct(final quickfix.field.Product value) {
    ...
    public NoQuoteEntries setProductComplex(final String value) {
      setField(FieldValue.to(productComplexField, value));
      return this;
    }
    public NoQuoteEntries setProductComplex(final quickfix.field.ProductComplex value) {
    ...
    public NoQuoteEntries setSecurityGroup(final String value) {
      setField(FieldValue.to(securityGroupField, value));
      return this;
    }
    public NoQuoteEntries setSecurityGroup(final quickfix.field.SecurityGroup value) {
    ...
    public NoQuoteEntries setCfiCode(final String value) {
      setField(FieldValue.to(cfiCodeField, value));
      return this;
    }
    public NoQuoteEntries setCfiCode(final quickfix.field.CFICode value) {
    ...
    public NoQuoteEntries setSecuritySubType(final String value) {
      setField(FieldValue.to(securitySubTypeField, value));
      return this;
    }
    public NoQuoteEntries setSecuritySubType(final quickfix.field.SecuritySubType value) {
    ...
    public NoQuoteEntries setMaturityDate(final String value) {
      setField(FieldValue.to(maturityDateField, value));
      return this;
    }
    public NoQuoteEntries setMaturityDate(final quickfix.field.MaturityDate value) {
    ...
    public NoQuoteEntries setMaturityTime(final String value) {
      setField(FieldValue.to(maturityTimeField, value));
      return this;
    }
    public NoQuoteEntries setMaturityTime(final quickfix.field.MaturityTime value) {
    ...
    public NoQuoteEntries setSettleOnOpenFlag(final String value) {
      setField(FieldValue.to(settleOnOpenFlagField, value));
      return this;
    }
    public NoQuoteEntries setSettleOnOpenFlag(final quickfix.field.SettleOnOpenFlag value) {
    ...
    public NoQuoteEntries setInstrmtAssignmentMethod(final int value) {
      setField(FieldValue.to(instrmtAssignmentMethodField, value));
      return this;
    }
    public NoQuoteEntries setInstrmtAssignmentMethod(final char value) {
      setField(FieldValue.to(instrmtAssignmentMethodField, value));
      return this;
    }
    public NoQuoteEntries setInstrmtAssignmentMethod(final String value) {
      setField(FieldValue.to(instrmtAssignmentMethodField, value));
      return this;
    }
    public NoQuoteEntries setInstrmtAssignmentMethod(
    ...
    public NoQuoteEntries setSecurityStatus(final String value) {
      setField(FieldValue.to(securityStatusField, value));
      return this;
    }
    public NoQuoteEntries setSecurityStatus(final quickfix.field.SecurityStatus value) {
    ...
    public NoQuoteEntries setCouponPaymentDate(final String value) {
      setField(FieldValue.to(couponPaymentDateField, value));
      return this;
    }
    public NoQuoteEntries setCouponPaymentDate(final quickfix.field.CouponPaymentDate value) {
    ...
    public NoQuoteEntries setRestructuringType(final String value) {
      setField(FieldValue.to(restructuringTypeField, value));
      return this;
    }
    public NoQuoteEntries setRestructuringType(final quickfix.field.RestructuringType value) {
    ...
    public NoQuoteEntries setSeniority(final String value) {
      setField(FieldValue.to(seniorityField, value));
      return this;
    }
    public NoQuoteEntries setSeniority(final quickfix.field.Seniority value) {
    ...
    public NoQuoteEntries setNotionalPercentageOutstanding(final double value) {
      setField(FieldValue.to(notionalPercentageOutstandingField, value));
      return this;
    }
    public NoQuoteEntries setNotionalPercentageOutstanding(
    ...
    public NoQuoteEntries setOriginalNotionalPercentageOutstanding(final double value) {
      setField(FieldValue.to(originalNotionalPercentageOutstandingField, value));
      return this;
    }
    public NoQuoteEntries setOriginalNotionalPercentageOutstanding(
    ...
    public NoQuoteEntries setAttachmentPoint(final double value) {
      setField(FieldValue.to(attachmentPointField, value));
      return this;
    }
    public NoQuoteEntries setAttachmentPoint(final quickfix.field.AttachmentPoint value) {
    ...
    public NoQuoteEntries setDetachmentPoint(final double value) {
      setField(FieldValue.to(detachmentPointField, value));
      return this;
    }
    public NoQuoteEntries setDetachmentPoint(final quickfix.field.DetachmentPoint value) {
    ...
    public NoQuoteEntries setIssueDate(final String value) {
      setField(FieldValue.to(issueDateField, value));
      return this;
    }
    public NoQuoteEntries setIssueDate(final quickfix.field.IssueDate value) {
    ...
    public NoQuoteEntries setRepoCollateralSecurityType(final String value) {
      setField(FieldValue.to(repoCollateralSecurityTypeField, value));
      return this;
    }
    public NoQuoteEntries setRepoCollateralSecurityType(
    ...
    public NoQuoteEntries setRepurchaseTerm(final int value) {
      setField(FieldValue.to(repurchaseTermField, value));
      return this;
    }
    public NoQuoteEntries setRepurchaseTerm(final quickfix.field.RepurchaseTerm value) {
    ...
    public NoQuoteEntries setRepurchaseRate(final double value) {
      setField(FieldValue.to(repurchaseRateField, value));
      return this;
    }
    public NoQuoteEntries setRepurchaseRate(final quickfix.field.RepurchaseRate value) {
    ...
    public NoQuoteEntries setFactor(final double value) {
      setField(FieldValue.to(factorField, value));
      return this;
    }
    public NoQuoteEntries setFactor(final quickfix.field.Factor value) {
    ...
    public NoQuoteEntries setCreditRating(final String value) {
      setField(FieldValue.to(creditRatingField, value));
      return this;
    }
    public NoQuoteEntries setCreditRating(final quickfix.field.CreditRating value) {
    ...
    public NoQuoteEntries setInstrRegistry(final String value) {
      setField(FieldValue.to(instrRegistryField, value));
      return this;
    }
    public NoQuoteEntries setInstrRegistry(final quickfix.field.InstrRegistry value) {
    ...
    public NoQuoteEntries setCountryOfIssue(final String value) {
      setField(FieldValue.to(countryOfIssueField, value));
      return this;
    }
    public NoQuoteEntries setCountryOfIssue(final quickfix.field.CountryOfIssue value) {
    ...
    public NoQuoteEntries setStateOrProvinceOfIssue(final String value) {
      setField(FieldValue.to(stateOrProvinceOfIssueField, value));
      return this;
    }
    public NoQuoteEntries setStateOrProvinceOfIssue(
    ...
    public NoQuoteEntries setLocaleOfIssue(final String value) {
      setField(FieldValue.to(localeOfIssueField, value));
      return this;
    }
    public NoQuoteEntries setLocaleOfIssue(final quickfix.field.LocaleOfIssue value) {
    ...
    public NoQuoteEntries setRedemptionDate(final String value) {
      setField(FieldValue.to(redemptionDateField, value));
      return this;
    }
    public NoQuoteEntries setRedemptionDate(final quickfix.field.RedemptionDate value) {
    ...
    public NoQuoteEntries setStrikeCurrency(final String value) {
      setField(FieldValue.to(strikeCurrencyField, value));
      return this;
    }
    public NoQuoteEntries setStrikeCurrency(final quickfix.field.StrikeCurrency value) {
    ...
    public NoQuoteEntries setStrikeMultiplier(final double value) {
      setField(FieldValue.to(strikeMultiplierField, value));
      return this;
    }
    public NoQuoteEntries setStrikeMultiplier(final quickfix.field.StrikeMultiplier value) {
    ...
    public NoQuoteEntries setStrikeValue(final double value) {
      setField(FieldValue.to(strikeValueField, value));
      return this;
    }
    public NoQuoteEntries setStrikeValue(final quickfix.field.StrikeValue value) {
    ...
    public NoQuoteEntries setStrikePriceDeterminationMethod(final int value) {
      setField(FieldValue.to(strikePriceDeterminationMethodField, value));
      return this;
    }
    public NoQuoteEntries setStrikePriceDeterminationMethod(
    ...
    public NoQuoteEntries setStrikePriceBoundaryMethod(final int value) {
      setField(FieldValue.to(strikePriceBoundaryMethodField, value));
      return this;
    }
    public NoQuoteEntries setStrikePriceBoundaryMethod(
    ...
    public NoQuoteEntries setStrikePriceBoundaryPrecision(final double value) {
      setField(FieldValue.to(strikePriceBoundaryPrecisionField, value));
      return this;
    }
    public NoQuoteEntries setStrikePriceBoundaryPrecision(
    ...
    public NoQuoteEntries setUnderlyingPriceDeterminationMethod(final int value) {
      setField(FieldValue.to(underlyingPriceDeterminationMethodField, value));
      return this;
    }
    public NoQuoteEntries setUnderlyingPriceDeterminationMethod(
    ...
    public NoQuoteEntries setContractMultiplierUnit(final int value) {
      setField(FieldValue.to(contractMultiplierUnitField, value));
      return this;
    }
    public NoQuoteEntries setContractMultiplierUnit(
    ...
    public NoQuoteEntries setFlowScheduleType(final int value) {
      setField(FieldValue.to(flowScheduleTypeField, value));
      return this;
    }
    public NoQuoteEntries setFlowScheduleType(final quickfix.field.FlowScheduleType value) {
    ...
    public NoQuoteEntries setMinPriceIncrement(final double value) {
      setField(FieldValue.to(minPriceIncrementField, value));
      return this;
    }
    public NoQuoteEntries setMinPriceIncrement(final quickfix.field.MinPriceIncrement value) {
    ...
    public NoQuoteEntries setMinPriceIncrementAmount(final double value) {
      setField(FieldValue.to(minPriceIncrementAmountField, value));
      return this;
    }
    public NoQuoteEntries setMinPriceIncrementAmount(
    ...
    public NoQuoteEntries setUnitOfMeasure(final String value) {
      setField(FieldValue.to(unitOfMeasureField, value));
      return this;
    }
    public NoQuoteEntries setUnitOfMeasure(final quickfix.field.UnitOfMeasure value) {
    ...
    public NoQuoteEntries setUnitOfMeasureQty(final double value) {
      setField(FieldValue.to(unitOfMeasureQtyField, value));
      return this;
    }
    public NoQuoteEntries setUnitOfMeasureQty(final quickfix.field.UnitOfMeasureQty value) {
    ...
    public NoQuoteEntries setPriceUnitOfMeasure(final String value) {
      setField(FieldValue.to(priceUnitOfMeasureField, value));
      return this;
    }
    public NoQuoteEntries setPriceUnitOfMeasure(final quickfix.field.PriceUnitOfMeasure value) {
    ...
    public NoQuoteEntries setPriceUnitOfMeasureQty(final double value) {
      setField(FieldValue.to(priceUnitOfMeasureQtyField, value));
      return this;
    }
    public NoQuoteEntries setPriceUnitOfMeasureQty(
    ...
    public NoQuoteEntries setSettlMethod(final int value) {
      setField(FieldValue.to(settlMethodField, value));
      return this;
    }
    public NoQuoteEntries setSettlMethod(final char value) {
      setField(FieldValue.to(settlMethodField, value));
      return this;
    }
    public NoQuoteEntries setSettlMethod(final String value) {
      setField(FieldValue.to(settlMethodField, value));
      return this;
    }
    public NoQuoteEntries setSettlMethod(final quickfix.field.SettlMethod value) {
    ...
    public NoQuoteEntries setExerciseStyle(final int value) {
      setField(FieldValue.to(exerciseStyleField, value));
      return this;
    }
    public NoQuoteEntries setExerciseStyle(final quickfix.field.ExerciseStyle value) {
    ...
    public NoQuoteEntries setOptPayoutType(final int value) {
      setField(FieldValue.to(optPayoutTypeField, value));
      return this;
    }
    public NoQuoteEntries setOptPayoutType(final quickfix.field.OptPayoutType value) {
    ...
    public NoQuoteEntries setOptPayoutAmount(final double value) {
      setField(FieldValue.to(optPayoutAmountField, value));
      return this;
    }
    public NoQuoteEntries setOptPayoutAmount(final quickfix.field.OptPayoutAmount value) {
    ...
    public NoQuoteEntries setPriceQuoteMethod(final String value) {
      setField(FieldValue.to(priceQuoteMethodField, value));
      return this;
    }
    public NoQuoteEntries setPriceQuoteMethod(final quickfix.field.PriceQuoteMethod value) {
    ...
    public NoQuoteEntries setValuationMethod(final String value) {
      setField(FieldValue.to(valuationMethodField, value));
      return this;
    }
    public NoQuoteEntries setValuationMethod(final quickfix.field.ValuationMethod value) {
    ...
    public NoQuoteEntries setListMethod(final int value) {
      setField(FieldValue.to(listMethodField, value));
      return this;
    }
    public NoQuoteEntries setListMethod(final quickfix.field.ListMethod value) {
    ...
    public NoQuoteEntries setCapPrice(final double value) {
      setField(FieldValue.to(capPriceField, value));
      return this;
    }
    public NoQuoteEntries setCapPrice(final quickfix.field.CapPrice value) {
    ...
    public NoQuoteEntries setFloorPrice(final double value) {
      setField(FieldValue.to(floorPriceField, value));
      return this;
    }
    public NoQuoteEntries setFloorPrice(final quickfix.field.FloorPrice value) {
    ...
    public NoQuoteEntries setFlexibleIndicator(final boolean value) {
      setField(FieldValue.to(flexibleIndicatorField, value));
      return this;
    }
    public NoQuoteEntries setFlexibleIndicator(final quickfix.field.FlexibleIndicator value) {
    ...
    public NoQuoteEntries setFlexProductEligibilityIndicator(final boolean value) {
      setField(FieldValue.to(flexProductEligibilityIndicatorField, value));
      return this;
    }
    public NoQuoteEntries setFlexProductEligibilityIndicator(
    ...
    public NoQuoteEntries setTimeUnit(final String value) {
      setField(FieldValue.to(timeUnitField, value));
      return this;
    }
    public NoQuoteEntries setTimeUnit(final quickfix.field.TimeUnit value) {
    ...
    public NoQuoteEntries setPositionLimit(final int value) {
      setField(FieldValue.to(positionLimitField, value));
      return this;
    }
    public NoQuoteEntries setPositionLimit(final quickfix.field.PositionLimit value) {
    ...
    public NoQuoteEntries setNtPositionLimit(final int value) {
      setField(FieldValue.to(ntPositionLimitField, value));
      return this;
    }
    public NoQuoteEntries setNtPositionLimit(final quickfix.field.NTPositionLimit value) {
    ...
    public NoQuoteEntries setSecurityXmlLen(final int value) {
      setField(FieldValue.to(securityXmlLenField, value));
      return this;
    }
    public NoQuoteEntries setSecurityXmlLen(final quickfix.field.SecurityXMLLen value) {
    ...
    public NoQuoteEntries setSecurityXmlData(final String value) {
      setField(FieldValue.to(securityXmlDataField, value));
      return this;
    }
    public NoQuoteEntries setSecurityXmlData(final quickfix.field.SecurityXMLData value) {
    ...
    public NoQuoteEntries setSecurityXmlSchema(final String value) {
      setField(FieldValue.to(securityXmlSchemaField, value));
      return this;
    }
    public NoQuoteEntries setSecurityXmlSchema(final quickfix.field.SecurityXMLSchema value) {
    ...
    public NoQuoteEntries setPool(final String value) {
      setField(FieldValue.to(poolField, value));
      return this;
    }
    public NoQuoteEntries setPool(final quickfix.field.Pool value) {
    ...
    public NoQuoteEntries setContractSettlMonth(final String value) {
      setField(FieldValue.to(contractSettlMonthField, value));
      return this;
    }
    public NoQuoteEntries setContractSettlMonth(final quickfix.field.ContractSettlMonth value) {
    ...
    public NoQuoteEntries setCpProgram(final int value) {
      setField(FieldValue.to(cpProgramField, value));
      return this;
    }
    public NoQuoteEntries setCpProgram(final quickfix.field.CPProgram value) {
    ...
    public NoQuoteEntries setCpRegType(final String value) {
      setField(FieldValue.to(cpRegTypeField, value));
      return this;
    }
    public NoQuoteEntries setCpRegType(final quickfix.field.CPRegType value) {
    ...
    public NoQuoteEntries setDatedDate(final String value) {
      setField(FieldValue.to(datedDateField, value));
      return this;
    }
    public NoQuoteEntries setDatedDate(final quickfix.field.DatedDate value) {
    ...
    public NoQuoteEntries setInterestAccrualDate(final String value) {
      setField(FieldValue.to(interestAccrualDateField, value));
      return this;
    }
    public NoQuoteEntries setInterestAccrualDate(final quickfix.field.InterestAccrualDate value) {
    ...
    public NoQuoteEntries setAgreementDesc(final String value) {
      setField(FieldValue.to(agreementDescField, value));
      return this;
    }
    public NoQuoteEntries setAgreementDesc(final quickfix.field.AgreementDesc value) {
    ...
    public NoQuoteEntries setAgreementId(final String value) {
      setField(FieldValue.to(agreementIdField, value));
      return this;
    }
    public NoQuoteEntries setAgreementId(final quickfix.field.AgreementID value) {
    ...
    public NoQuoteEntries setAgreementDate(final String value) {
      setField(FieldValue.to(agreementDateField, value));
      return this;
    }
    public NoQuoteEntries setAgreementDate(final quickfix.field.AgreementDate value) {
    ...
    public NoQuoteEntries setAgreementCurrency(final String value) {
      setField(FieldValue.to(agreementCurrencyField, value));
      return this;
    }
    public NoQuoteEntries setAgreementCurrency(final quickfix.field.AgreementCurrency value) {
    ...
    public NoQuoteEntries setTerminationType(final int value) {
      setField(FieldValue.to(terminationTypeField, value));
      return this;
    }
    public NoQuoteEntries setTerminationType(final quickfix.field.TerminationType value) {
    ...
    public NoQuoteEntries setStartDate(final String value) {
      setField(FieldValue.to(startDateField, value));
      return this;
    }
    public NoQuoteEntries setStartDate(final quickfix.field.StartDate value) {
    ...
    public NoQuoteEntries setEndDate(final String value) {
      setField(FieldValue.to(endDateField, value));
      return this;
    }
    public NoQuoteEntries setEndDate(final quickfix.field.EndDate value) {
    ...
    public NoQuoteEntries setDeliveryType(final int value) {
      setField(FieldValue.to(deliveryTypeField, value));
      return this;
    }
    public NoQuoteEntries setDeliveryType(final quickfix.field.DeliveryType value) {
    ...
    public NoQuoteEntries setMarginRatio(final double value) {
      setField(FieldValue.to(marginRatioField, value));
      return this;
    }
    public NoQuoteEntries setMarginRatio(final quickfix.field.MarginRatio value) {
    ...
    public NoQuoteEntries() {
      super(295, 55,
          new int[] {55, 65, 48, 22, 460, 1227, 1151, 461, 167, 762, 200, 541, 1079, 966, 1049, 965,
              ...
              691, 667, 875, 876, 873, 874, 913, 914, 915, 918, 788, 916, 917, 919, 898, 0});
    }
    ...
    public void fromProto(
        final garden_leave.fix50sp2.proto.FIX50SP2Protos.QuoteCancel.NoQuoteEntries proto) {
      final garden_leave.fix50sp2.proto.FIX50SP2Protos.QuoteCancel.NoQuoteEntries
          .FieldPresence fieldPresence = proto.getFieldPresence();

      for (int i = 0; i < proto.getNoSecurityAltIdCount(); i++) {
        final NoQuoteEntries.NoSecurityAltId group = new NoQuoteEntries.NoSecurityAltId();
        group.fromProto(proto.getNoSecurityAltId(i));
        this.addGroupRef(group);
      }
      for (int i = 0; i < proto.getNoEventsCount(); i++) {
        final NoQuoteEntries.NoEvents group = new NoQuoteEntries.NoEvents();
        group.fromProto(proto.getNoEvents(i));
        this.addGroupRef(group);
      }
      for (int i = 0; i < proto.getNoInstrumentPartiesCount(); i++) {
        final NoQuoteEntries.NoInstrumentParties group = new NoQuoteEntries.NoInstrumentParties();
        group.fromProto(proto.getNoInstrumentParties(i));
        this.addGroupRef(group);
      }
      for (int i = 0; i < proto.getNoComplexEventsCount(); i++) {
        final NoQuoteEntries.NoComplexEvents group = new NoQuoteEntries.NoComplexEvents();
        group.fromProto(proto.getNoComplexEvents(i));
        this.addGroupRef(group);
      }
      for (int i = 0; i < proto.getNoUnderlyingsCount(); i++) {
        final NoQuoteEntries.NoUnderlyings group = new NoQuoteEntries.NoUnderlyings();
        group.fromProto(proto.getNoUnderlyings(i));
        this.addGroupRef(group);
      }
      for (int i = 0; i < proto.getNoLegsCount(); i++) {
        final NoQuoteEntries.NoLegs group = new NoQuoteEntries.NoLegs();
    ...
    public garden_leave.fix50sp2.proto.FIX50SP2Protos.QuoteCancel.NoQuoteEntries.Builder toBuilder()
        throws quickfix.FieldNotFound {
      final garden_leave.fix50sp2.proto.FIX50SP2Protos.QuoteCancel.NoQuoteEntries.Builder builder =
          garden_leave.fix50sp2.proto.FIX50SP2Protos.QuoteCancel.NoQuoteEntries.newBuilder();
      final garden_leave.fix50sp2.proto.FIX50SP2Protos.QuoteCancel.NoQuoteEntries.FieldPresence
          .Builder presenceBuilder = garden_leave.fix50sp2.proto.FIX50SP2Protos.QuoteCancel
                                         .NoQuoteEntries.FieldPresence.newBuilder();
  ...
  public QuoteCancel setQuoteMsgId(final String value) {
    setField(FieldValue.to(quoteMsgIdField, value));
    return this;
  }
  public QuoteCancel setQuoteMsgId(final quickfix.field.QuoteMsgID value) {
  ...
  public QuoteCancel setQuoteType(final int value) {
    setField(FieldValue.to(quoteTypeField, value));
    return this;
  }
  public QuoteCancel setQuoteType(final quickfix.field.QuoteType value) {
  ...
  public QuoteCancel setAccount(final String value) {
    setField(FieldValue.to(accountField, value));
    return this;
  }
  public QuoteCancel setAccount(final quickfix.field.Account value) {
  ...
  public QuoteCancel setAcctIdSource(final int value) {
    setField(FieldValue.to(acctIdSourceField, value));
    return this;
  }
  public QuoteCancel setAcctIdSource(final quickfix.field.AcctIDSource value) {
  ...
  public QuoteCancel setAccountType(final int value) {
    setField(FieldValue.to(accountTypeField, value));
    return this;
  }
  public QuoteCancel setAccountType(final quickfix.field.AccountType value) {
  ...
  public QuoteCancel setTradingSessionSubId(final String value) {
    setField(FieldValue.to(tradingSessionSubIdField, value));
    return this;
  }
  public QuoteCancel setTradingSessionSubId(final quickfix.field.TradingSessionSubID value) {
    setField(FieldValue.to(tradingSessionSubIdField, FieldValue.of(value)));
    return this;
  }

  public QuoteCancel() {
    super(new int[] {131, 117, 1166, 298, 537, 301, 1, 660, 581, 336, 625, 0});
  }
  ...
  public static Function<garden_leave.gateway.transform.fix50sp2.QuoteCancel,
      garden_leave.fix50sp2.proto.FIX50SP2Protos.QuoteCancel> fixToProto = (fix) -> {
    if (fix == null) {
      return garden_leave.fix50sp2.proto.FIX50SP2Protos.QuoteCancel.getDefaultInstance();
    }

    final garden_leave.fix50sp2.proto.FIX50SP2Protos.QuoteCancel.Builder builder =
        garden_leave.fix50sp2.proto.FIX50SP2Protos.QuoteCancel.newBuilder();
    final garden_leave.fix50sp2.proto.FIX50SP2Protos.QuoteCancel.FieldPresence
        .Builder presenceBuilder =
        garden_leave.fix50sp2.proto.FIX50SP2Protos.QuoteCancel.FieldPresence.newBuilder();
    ...
    try {
      ...
      for (int i = 1; i <= noPartyIdsGroupCount; i++) {
        final QuoteCancel.NoPartyIds group = new QuoteCancel.NoPartyIds();
        fix.getGroup(i, group);
        builder.addNoPartyIds(group.toBuilder().build());
      }

      final int noTargetPartyIdsGroupCount = fix.getGroupCount(1461);
      for (int i = 1; i <= noTargetPartyIdsGroupCount; i++) {
        final QuoteCancel.NoTargetPartyIds group = new QuoteCancel.NoTargetPartyIds();
        fix.getGroup(i, group);
        builder.addNoTargetPartyIds(group.toBuilder().build());
      }
  ...
  public static Function<garden_leave.fix50sp2.proto.FIX50SP2Protos.QuoteCancel,
      garden_leave.gateway.transform.fix50sp2.QuoteCancel> protoToFix = (proto) -> {
    final io.opentelemetry.api.trace.Span span = garden_leave.utils.Telemetry.startSpan(
        tracer, "garden_leave.gateway.transform.fix50sp2.QuoteCancel.protoToFix");
    try (io.opentelemetry.context.Scope ignored = span.makeCurrent()) {
      final garden_leave.gateway.transform.fix50sp2.QuoteCancel fix =
      ...
      final garden_leave.fix50sp2.proto.FIX50SP2Protos.QuoteCancel.FieldPresence fieldPresence =
          proto.getFieldPresence();
      ...
      for (int i = 0; i < proto.getNoTargetPartyIdsCount(); i++) {
        final QuoteCancel.NoTargetPartyIds group = new QuoteCancel.NoTargetPartyIds();
        group.fromProto(proto.getNoTargetPartyIds(i));
        fix.addGroupRef(group);
      }
