...
public final class Header extends quickfix.Message.Header {
  ...
  private final quickfix.StringField applVerIdField = FieldFactory.newStringField(1128);
  public boolean hasApplVerId() throws quickfix.FieldNotFound {
    return isSetField(1128);
  }
  public String getApplVerId() throws quickfix.FieldNotFound {
    return FieldValue.of(getField(applVerIdField));
  }
  public Header setApplVerId(final String value) {
    setField(FieldValue.to(applVerIdField, value));
    return this;
  }
  public Header setApplVerId(final quickfix.field.ApplVerID value) {
    setField(FieldValue.to(applVerIdField, FieldValue.of(value)));
    return this;
  }

  private final quickfix.IntField applExtIdField = FieldFactory.newIntField(1156);
  public boolean hasApplExtId() throws quickfix.FieldNotFound {
    return isSetField(1156);
  }
  public int getApplExtId() throws quickfix.FieldNotFound {
    return FieldValue.of(getField(applExtIdField));
  }
  public Header setApplExtId(final int value) {
    setField(FieldValue.to(applExtIdField, value));
    return this;
  }
  public Header setApplExtId(final quickfix.field.ApplExtID value) {
    setField(FieldValue.to(applExtIdField, FieldValue.of(value)));
    return this;
  }

  private final quickfix.StringField cstmApplVerIdField = FieldFactory.newStringField(1129);
  public boolean hasCstmApplVerId() throws quickfix.FieldNotFound {
    return isSetField(1129);
  }
  public String getCstmApplVerId() throws quickfix.FieldNotFound {
    return FieldValue.of(getField(cstmApplVerIdField));
  }
  public Header setCstmApplVerId(final String value) {
    setField(FieldValue.to(cstmApplVerIdField, value));
    return this;
  }
  public Header setCstmApplVerId(final quickfix.field.CstmApplVerID value) {
    setField(FieldValue.to(cstmApplVerIdField, FieldValue.of(value)));
    return this;
  }
  ...
  public Header(final quickfix.Message msg, final String beginString, final String msgType) {
    super(new int[] {8, 9, 35, 1128, 1156, 1129, 49, 56, 115, 128, 90, 91, 34, 50, 142, 57, 143,
        116, 144, 129, 145, 43, 97, 52, 122, 212, 213, 347, 369, 0});
    setMsgType(msgType);
    setBeginString(beginString);
  }

  public void fromProto(final garden_leave.fix50sp2.proto.FIX50SP2Protos.Header proto) {
    final garden_leave.fix50sp2.proto.FIX50SP2Protos.Header.FieldPresence fieldPresence =
    ...
    if (fieldPresence.getApplVerId()) {
      this.setApplVerId(proto.getApplVerId());
    }
    if (fieldPresence.getApplExtId()) {
      this.setApplExtId(proto.getApplExtId());
    }
    if (fieldPresence.getCstmApplVerId()) {
      this.setCstmApplVerId(proto.getCstmApplVerId());
    }
  ...
  public garden_leave.fix50sp2.proto.FIX50SP2Protos.Header.Builder toBuilder()
      throws quickfix.FieldNotFound {
    final garden_leave.fix50sp2.proto.FIX50SP2Protos.Header.Builder builder =
        garden_leave.fix50sp2.proto.FIX50SP2Protos.Header.newBuilder();
    final garden_leave.fix50sp2.proto.FIX50SP2Protos.Header.FieldPresence.Builder presenceBuilder =
        garden_leave.fix50sp2.proto.FIX50SP2Protos.Header.FieldPresence.newBuilder();
    ...
    if (this.hasApplVerId()) {
      builder.setApplVerId(this.getApplVerId());
      presenceBuilder.setApplVerId(true);
    }
    if (this.hasApplExtId()) {
      builder.setApplExtId(this.getApplExtId());
      presenceBuilder.setApplExtId(true);
    }
    if (this.hasCstmApplVerId()) {
      builder.setCstmApplVerId(this.getCstmApplVerId());
      presenceBuilder.setCstmApplVerId(true);
    }
