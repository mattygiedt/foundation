...
public final class SequenceReset extends quickfix.Message {
  ...
  public static Function<garden_leave.gateway.transform.fixt11.SequenceReset,
      garden_leave.fixt11.proto.FIXT11Protos.SequenceReset> fixToProto = (fix) -> {
    if (fix == null) {
      return garden_leave.fixt11.proto.FIXT11Protos.SequenceReset.getDefaultInstance();
    }

    final garden_leave.fixt11.proto.FIXT11Protos.SequenceReset.Builder builder =
        garden_leave.fixt11.proto.FIXT11Protos.SequenceReset.newBuilder();
    final garden_leave.fixt11.proto.FIXT11Protos.SequenceReset.FieldPresence
        .Builder presenceBuilder =
        garden_leave.fixt11.proto.FIXT11Protos.SequenceReset.FieldPresence.newBuilder();
  ...
  public static Function<garden_leave.fixt11.proto.FIXT11Protos.SequenceReset,
      garden_leave.gateway.transform.fixt11.SequenceReset> protoToFix = (proto) -> {
    final io.opentelemetry.api.trace.Span span = garden_leave.utils.Telemetry.startSpan(
        tracer, "garden_leave.gateway.transform.fixt11.SequenceReset.protoToFix");
    try (io.opentelemetry.context.Scope ignored = span.makeCurrent()) {
      final garden_leave.gateway.transform.fixt11.SequenceReset fix =
      ...
      final garden_leave.fixt11.proto.FIXT11Protos.SequenceReset.FieldPresence fieldPresence =
