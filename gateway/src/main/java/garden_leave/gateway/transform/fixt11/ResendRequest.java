...
public final class ResendRequest extends quickfix.Message {
  ...
  public static Function<garden_leave.gateway.transform.fixt11.ResendRequest,
      garden_leave.fixt11.proto.FIXT11Protos.ResendRequest> fixToProto = (fix) -> {
    if (fix == null) {
      return garden_leave.fixt11.proto.FIXT11Protos.ResendRequest.getDefaultInstance();
    }

    final garden_leave.fixt11.proto.FIXT11Protos.ResendRequest.Builder builder =
        garden_leave.fixt11.proto.FIXT11Protos.ResendRequest.newBuilder();
    final garden_leave.fixt11.proto.FIXT11Protos.ResendRequest.FieldPresence
        .Builder presenceBuilder =
        garden_leave.fixt11.proto.FIXT11Protos.ResendRequest.FieldPresence.newBuilder();
  ...
  public static Function<garden_leave.fixt11.proto.FIXT11Protos.ResendRequest,
      garden_leave.gateway.transform.fixt11.ResendRequest> protoToFix = (proto) -> {
    final io.opentelemetry.api.trace.Span span = garden_leave.utils.Telemetry.startSpan(
        tracer, "garden_leave.gateway.transform.fixt11.ResendRequest.protoToFix");
    try (io.opentelemetry.context.Scope ignored = span.makeCurrent()) {
      final garden_leave.gateway.transform.fixt11.ResendRequest fix =
      ...
      final garden_leave.fixt11.proto.FIXT11Protos.ResendRequest.FieldPresence fieldPresence =
