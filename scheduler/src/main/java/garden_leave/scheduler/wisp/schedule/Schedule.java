...
public interface Schedule {
   ...
   * @param lastExecutionEndedTimeInMillis The time at which the job has last been executed; will be
   *     null
  ...
  long nextExecutionInMillis(
      long currentTimeInMillis, int executionsCount, Long lastExecutionEndedTimeInMillis);
}
